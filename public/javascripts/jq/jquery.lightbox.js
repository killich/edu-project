...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		text: {
			...
			of:			'из',
			close:		'Закрыть',
			closeInfo:	'Вы можете также щелкнуть по свободной области экрана для завершения просмотра',
			help: {
				close:		'Щелчок мыши на фоне &mdash; завершит просмотр',
				interact:	''
			},
			about: {
				text: 	'OOO "Вектор +"',
				title:	'г.Иваново, Производство перчаток ПВХ',
				link:	'#'
			}
		},
		show_linkback:	true,
