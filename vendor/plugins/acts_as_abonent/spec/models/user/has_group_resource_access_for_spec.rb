...
describe '15:21 18.07.2009' do  
    ...
    it '13:05 17.07.2009' do
      @admin.has_group_resource_access_for?(@ivanov, :profile, :edit, :recalculate=>true).should be_false
      @admin.has_group_resource_access_for?(@petrov, :profile, :edit, :recalculate=>true).should be_false
    end
    ...
    it '15:36 19.07.2009' do
      ...
      @admin.has_group_resource_access_for?(@admin, :page, :manager).should be_false
    end
    ...
    it '11:48 15.07.2009' do
      ...
      @admin.has_group_resource_access_for?(@ivanov, :pages, :manager).should be_false
    end
    ...
    it '12:40 19.07.2009' do
      admin_has_resources
      @resource_ivanov.update_attributes(:start_at=>DateTime.now-1.second, :finish_at=>DateTime.now+10.seconds)
      @admin.has_group_resource_access_for?(@ivanov, :pages, :manager).should be_true
    end
    ...
    it '12:49 19.07.2009' do
      ...
      # хеш пересчитан
      @admin.has_group_resource_access_for?(@ivanov, :pages, :manager, :recalculate=> true).should be_false
      @admin.has_group_resource_access_for?(@petrov, :pages, :manager).should be_false
    end
end
