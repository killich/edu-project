...
describe '15:21 18.07.2009' do  
    ...
    it '13:05 17.07.2009' do
      @admin.has_personal_resource_block_for?(@ivanov, :profile, :edit, :recalculate=>true).should be_false
      @admin.has_personal_resource_block_for?(@petrov, :profile, :edit, :recalculate=>true).should be_false
    end
    ...
    it '15:36 19.07.2009' do
      ...
      @admin.has_personal_resource_block_for?(@ivanov, :pages, :manager).should be_true
      @admin.has_personal_resource_block_for?(@petrov, :pages, :manager).should be_true
      
      @admin.has_personal_resource_block_for?(@petrov, 'pages', 'manager').should be_true
      @admin.has_personal_resource_block_for?(@ivanov, :pages, 'manager').should be_true
      @admin.has_personal_resource_block_for?(@petrov, 'pages', :manager).should be_true

      @admin.has_personal_resource_block_for?(@admin, :page, :manager).should be_false
    end
    ...
    it '11:48 15.07.2009' do
      ...
      @admin.has_personal_resource_block_for?(@ivanov, :pages, :manager).should be_false
    end
    ...
    it '12:49 19.07.2009' do
      ...
      # хеш пересчитан
      @admin.has_personal_resource_block_for?(@ivanov, :pages, :manager, :recalculate=> true).should be_false
      @admin.has_personal_resource_block_for?(@petrov, :pages, :manager).should be_false
    end
end
